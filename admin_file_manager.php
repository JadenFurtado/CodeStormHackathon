...
while($row=mysqli_fetch_array($res)){
    $auth_users[$row['instructor_name']] = $row['instructor_password'];   
    $directories_users[$row['instructor_name']]=$_SERVER['DOCUMENT_ROOT']."/code_editor/code/".$row['id'];
    $users_instructor[$row['instructor_name']]=$row['id'];
}
                                    ...
                                    <div class="form-group">
                                       <div class="brand">
                                        ...
                                        <div class="text-center">
                                            <h1 class="card-title"><?php echo 'Code editor' ?></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                           ...
                           <?php else: ?>
                                <a href="https://localhost/code_editor_1/public/Editor?p=&edit=<?php echo '/'.$users_instructor[$_SESSION['filemanager']['logged']].'/'.FM_PATH.'/'.$f ?>" title="<?php echo $f ?>">
                            <?php endif; ?>
