...
<header class="w3-display-container w3-center">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="https://miro.medium.com/max/2000/1*pKIjwoPgFlNqoGwe9LZTtw.jpeg" alt="Image 1" style="min-width:500px" width="1500" height="1000">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="https://blog-c7ff.kxcdn.com/blog/wp-content/uploads/2017/02/Blog-Cover-image-Fullstack-Highres.jpg" alt="Image 2" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="https://res.cloudinary.com/practicaldev/image/fetch/s--DxkKjhGP--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/s3un0bj59b1heym211tz.jpg" alt="Image 3" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
